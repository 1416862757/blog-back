    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="createTime" label="日期" sortable width="150" :formatter="formatter">
                </el-table-column>
        ...
        computed: {
            data() {
                return this.tableData.filter((d) => {
                    ...
                    // if (!is_del) {
                    //     if (d.mobile.indexOf(this.select_cate) > -1 &&
                    //         (d.username.indexOf(this.select_word) > -1 ||
                    //             d.mobile.indexOf(this.select_word) > -1)
                    //     ) {
                            return d;
                    //     }
                    // }
